          ...
          <Stack spacing={4}>
            ...
            <HStack>
              <FormControl id="email" isRequired>
                ...
                <Input autoComplete="off" autoFocus type="text" rounded={"full"} value={name.first} onChange={(e) => setName({ first: e.target.value, last: name.last })} />
              </FormControl>
              <FormControl id="email" isRequired>
            ...
            <FormControl id="password" isRequired>
              ...
              <InputGroup>
                <Input autoComplete="off" type={showPassword ? "text" : "password"} rounded={"full"} value={pass} onChange={(e) => setPass(e.target.value)} />
            ...
            <Stack spacing={10} pt={2}>
              <Button size={"lg"} type={"submit"} colorScheme={"teal"} rounded={"full"} isLoading={shouldBtnLoad}>
                Sign Up
              </Button>
            </Stack>
